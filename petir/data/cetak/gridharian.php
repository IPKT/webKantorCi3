...
<?php
	include "selectionGridHarian.php";
...
?>
	...
	<tr>
		<td align="center" colspan="2">
            ...
            Gambar 1.Peta sebaran sambaran petir pada tanggal <?php echo $_POST['TGLGrid']."-".$_POST['BLNGrid']."-".$_POST['THNGrid']; ?> di wilayah Bali.
        </td>
	</tr>
...
?>
	<tr>
		<td align="center" colspan="2">
            ...
            Gambar 2.Peta kontur sebaran sambaran petir pada tanggal <?php echo $_POST['TGLGrid']."-".$_POST['BLNGrid']."-".$_POST['THNGrid']; ?> di wilayah Bali.
        </td>
	</tr>
<?php
	if($_SESSION['Statuspengguna']=="Admin")
